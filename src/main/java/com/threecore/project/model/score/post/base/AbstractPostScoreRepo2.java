...
public abstract class AbstractPostScoreRepo2 implements PostScoreRepo2 {
	...
	@Override
	public abstract PostScore addComment(final long commentTimestamp, final long commentUserId, final long postCommentedId);
