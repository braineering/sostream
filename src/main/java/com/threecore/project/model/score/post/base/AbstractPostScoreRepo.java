...
public abstract class AbstractPostScoreRepo implements PostScoreRepo {
	...
	@Override
	public abstract PostScore addPost(Post post);
	
	@Override
	public abstract PostScore addComment(Comment comment);
