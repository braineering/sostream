...
import com.threecore.project.model.score.PostScoreRBTreeMap;
import com.threecore.project.model.score.PostScoreAVLTreeMap;
import com.threecore.project.model.PostScore;
import com.threecore.project.model.score.PostScoreMap;

public class PostRankingRBTreeMap extends AbstractPostRanking implements PostRanking {
	...
	public PostRankingRBTreeMap() {
		super();
		this.ranking = new ArrayList<PostScore>();
		this.map = new PostScoreAVLTreeMap();
	}
	
	public PostRankingRBTreeMap(final PostRanking other) {
		super(other);
		this.ranking = new ArrayList<PostScore>(other.getRanking());
		this.map = new PostScoreRBTreeMap();
	}
