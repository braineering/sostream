...
public class PostRankingAVLTreeMap extends AbstractPostRanking implements PostRanking {
	...
	public PostRankingAVLTreeMap() {
		super();
		this.ranking = new ArrayList<PostScore>();
		this.map = new PostScoreAVLTreeMap();
	}
	
	public PostRankingAVLTreeMap(final PostRanking other) {
		super(other);
