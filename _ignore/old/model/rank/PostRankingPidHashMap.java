...
import com.threecore.project.model.score.PostScorePidHashMap;
import com.threecore.project.model.PostScore;
import com.threecore.project.model.score.PostScoreMap;

public class PostRankingPidHashMap extends AbstractPostRanking implements PostRanking {
	...
	public PostRankingPidHashMap() {
		super();
		this.ranking = new ArrayList<PostScore>();
		this.map = new PostScorePidHashMap();
	}
	
	public PostRankingPidHashMap(final PostRanking other) {
		super(other);
