...
import com.threecore.project.operator.score.post.PostScoreMapperUpdaterTotal2;

public class QueryOne09 {

	private static final String JOB_NAME = "q1-9";
	...
	public static void main(String[] args) throws Exception {	
		...
		DataStream<PostScore> scores = events.flatMap(new PostScoreMapperUpdaterTotal2()).setParallelism(1);
